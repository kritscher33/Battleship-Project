...
{
    return g.addShip(5, 'A', "bean ship")  &&
           g.addShip(4, 'B', "LOSER PR FR FR")  &&
           g.addShip(3, 'D', "June Bug on a surf board")  &&
           g.addShip(3, 'S', "the goofiest ship of dem all")  &&
           g.addShip(2, 'P', "Kyle's hairy poopy butt");
}
int main()
{
    ...
    cout << "  2.  A human player against a good player" << endl;
    cout << "  3.  A standard game between a mediocre and a good player" << endl;
    cout << "  4.  A " << NTRIALS
    ...
    else if (line[0] == '1')
    {
        ...
        Player* p2 = createPlayer("good", "garrett", g);
        cout << "This mini-game has one ship, a 2-segment rowboat." << endl << endl;
        g.play(p1, p2);
        delete p1;
        delete p2;
    }
    else if (line[0] == '2')
    {
        Game g(10, 10);
        addStandardShips(g);
        Player* p1 = createPlayer("good", "Good Garrett", g);
    ...
    else if (line[0] == '3')
    {
        Game g(10, 10);
        addStandardShips(g);
        Player* p1 = createPlayer("mediocre", "Mediocre Marc", g);
        Player* p2 = createPlayer("good", "Good Garrett", g);
